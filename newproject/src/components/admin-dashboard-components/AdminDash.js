...
const AdminDash = () => {
  ...
  useEffect(() => {
    ...
    //       Phone_Number: 434343434,
    //       Profile_img:"https://images.unsplash.com/photo-1506748686214-e9df14d4d9d0?q=80&w=1374&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
    //     },
    //     {
    //       Username: "JaneSmith",
    ...
    <div className='Admin-Dash_main_div'>
        ...
        <div className='Admin-Dash_contnet_box'>
            ...
            <div className='Admin-Dash_contnet_section_div'>
                    ...
                    <span style={{color:"grey"}}>$2222020</span>
            </div>
        </div>
