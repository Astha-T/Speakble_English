        ...
        <div className='Teacher_list_style mt-3'>
                    ...
                    {teachers?.map((teacher) => (
                        <div key={teacher._id} className='teacher_card'>
                          ...
                          {teacher.Profile_Image[0]!="" 
                          ?<div className='teacher_card_img_div'>
                            <img src={`http://localhost:3000/images/${teacher.Profile_Image[0]}`} alt=''/>
                          </div>
                          :<div className='teacher_card_no_img'><p>{teacher.Username.slice(0,1).toUpperCase()}</p></div>}
